...
class InferenceWrapper(nn.Module):
    ...
    def generate_gradcam(self, image_path: Optional[str], save_dir: str, subject_name: str, slice_index: int, requires_multiclass: bool, img_tensor: torch.Tensor = None, predicted_class_name: Optional[str] = None, confidence: Optional[float] = None, binary_confidence: Optional[float] = None):
